...
const BtcPayPage = () => {
  ...
  return (
    <div>
      <div className="min-h-screen pt-20  bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 px-4 pb-8">
          ...
          <div className="bg-white max-w-md w-full p-8 rounded-2xl shadow-2xl border border-gray-200 hover:shadow-purple-300 transition-all duration-300">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:border-blue-300 dark:text-black"
        ...
        <p className="text-sm text-gray-600 dark:text-gray-600 mt-4 text-center italic px-2 py-2">
          If there's any extra fee during payment, no worries dear — our agents
          will gladly top it up in your game! 💖🎮💵
        </p>
      </div>
    </div>
  );
